...
OptimalBinningNumericMIP2Prep <- function(target, feature, max_n_prebins = 20L) {
    .Call(`_OptimalBinningWoE_OptimalBinningNumericMIP2Prep`, target, feature, max_n_prebins)
}
