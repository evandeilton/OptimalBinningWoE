...
#> 1: dealer_code      6       0.008           160 IV_BELOW_MIN;SMALL_BIN
```
...
#> [1] recipes_1.4.0            dplyr_1.2.1              OptimalBinningWoE_1.14.0
#> 
...
#> [37] future_1.76.0       purrr_1.2.2         listenv_1.0.0       splines_4.6.1      
