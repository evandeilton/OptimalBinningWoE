...
<!-- badges: start -->
[![R-CMD-check](https://github.com/evandeilton/OptimalBinningWoE/actions/workflows/R-CMD-check.yaml/badge.svg)](https://github.com/evandeilton/OptimalBinningWoE/actions/workflows/R-CMD-check.yaml) [![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://opensource.org/licenses/MIT)
...
where:
- \( P(X_i | Y = 1) \) is the proportion of positive cases (e.g., defaults) in bin \( i \),
- \( P(X_i | Y = 0) \) is the proportion of negative cases (e.g., non-defaults) in bin \( i \).
...
Contributions are welcome! Please open an issue or submit a pull request on [GitHub](https://evandeilton.github.io/OptimalBinningWoE/).
