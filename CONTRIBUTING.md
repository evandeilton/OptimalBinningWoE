...
If you find a bug, please check the [Issue Tracker](https://github.com/evandeilton/OptimalBinningWoE/issues) to see if it has already been reported. If not, please open a new issue and include:
...
3. Make your changes. Ensure you follow the coding style and add comments where necessary.
...
Please add tests for any new functionality. We use `testthat` for testing.
...
If you have questions, feel free to open a discussion or contact the maintainer.
