...
#>  [4] LC_COLLATE=en_US.UTF-8     LC_MONETARY=pt_BR.UTF-8    LC_MESSAGES=pt_BR.UTF-8   
...
#> [1] recipes_1.3.3            dplyr_1.2.1              OptimalBinningWoE_1.13.6
#> 
#> loaded via a namespace (and not attached):
#>  [1] xfun_0.60           bslib_0.11.0        htmlwidgets_1.6.4   lattice_0.22-9     
#>  [5] vctrs_0.7.3         tools_4.6.1         generics_0.1.4      parallel_4.6.1     
#>  [9] tibble_3.3.1        pkgconfig_2.0.3     Matrix_1.7-5        data.table_1.18.4  
#> [13] RColorBrewer_1.1-3  desc_1.4.3          lifecycle_1.0.5     compiler_4.6.1     
#> [17] farver_2.1.2        textshaping_1.0.5   codetools_0.2-20    DiceDesign_1.10    
#> [21] htmltools_0.5.9     class_7.3-23        sass_0.4.10         yaml_2.3.12        
#> [25] prodlim_2026.03.11  pillar_1.11.1       pkgdown_2.2.1       jquerylib_0.1.4    
#> [29] MASS_7.3-65         cachem_1.1.0        gower_1.0.2         rpart_4.1.27       
#> [33] parallelly_1.48.0   lava_1.9.2          dials_1.4.4         tidyselect_1.2.1   
#> [37] digest_0.6.39       future_1.75.0       purrr_1.2.2         listenv_1.0.0      
#> [41] splines_4.6.1       fastmap_1.2.0       grid_4.6.1          cli_3.6.6          
#> [45] magrittr_2.0.5      survival_3.8-6      utf8_1.2.6          future.apply_1.20.2
#> [49] withr_3.0.3         scales_1.4.0        lubridate_1.9.5     timechange_0.4.0   
#> [53] rmarkdown_2.31      globals_0.19.1      otel_0.2.0          nnet_7.3-20        
#> [57] timeDate_4052.112   ragg_1.5.2          evaluate_1.0.5      knitr_1.51         
#> [61] hardhat_1.4.3       rlang_1.3.0         Rcpp_1.1.2          glue_1.8.1         
#> [65] ipred_0.9-15        jsonlite_2.0.0      R6_2.6.1            systemfonts_1.3.2  
#> [69] fs_2.1.0
```
