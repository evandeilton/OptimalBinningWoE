...
#>  [4] furrr_0.3.1         otel_0.2.0          compiler_4.5.2     
#>  [7] systemfonts_1.3.1   vctrs_0.7.1         lhs_1.2.0          
#> [10] pkgconfig_2.0.3     fastmap_1.2.0       backports_1.5.0    
#> [13] labeling_0.4.3      utf8_1.2.6          rmarkdown_2.30     
#> [16] prodlim_2025.04.28  ragg_1.5.0          xfun_0.56          
#> [19] cachem_1.1.0        jsonlite_2.0.0      parallel_4.5.2     
#> [22] R6_2.6.1            bslib_0.10.0        stringi_1.8.7      
#> [25] RColorBrewer_1.1-3  parallelly_1.46.1   rpart_4.1.24       
#> [28] lubridate_1.9.5     jquerylib_0.1.4     Rcpp_1.1.1         
#> [31] iterators_1.0.14    knitr_1.51          future.apply_1.20.1
#> [34] Matrix_1.7-4        splines_4.5.2       nnet_7.3-20        
#> [37] timechange_0.4.0    tidyselect_1.2.1    rstudioapi_0.18.0  
#> [40] yaml_2.3.12         timeDate_4052.112   doParallel_1.0.17  
#> [43] codetools_0.2-20    listenv_0.10.0      lattice_0.22-7     
#> [46] tibble_3.3.1        withr_3.0.2         S7_0.2.1           
#> [49] evaluate_1.0.5      future_1.69.0       desc_1.4.3         
#> [52] survival_3.8-3      zip_2.3.3           xml2_1.5.2         
#> [55] pillar_1.11.1       foreach_1.5.2       generics_0.1.4     
#> [58] globals_0.19.0      class_7.3-23        glue_1.8.0         
#> [61] tools_4.5.2         data.table_1.18.2.1 openxlsx_4.2.8.1   
#> [64] gower_1.0.2         fs_1.6.6            grid_4.5.2         
#> [67] ipred_0.9-15        xefun_0.1.5         cli_3.6.5          
#> [70] DiceDesign_1.10     textshaping_1.0.4   lava_1.8.2         
#> [73] gtable_0.3.6        GPfit_1.0-9         sass_0.4.10        
#> [76] digest_0.6.39       htmlwidgets_1.6.4   farver_2.1.2       
#> [79] htmltools_0.5.9     pkgdown_2.2.0       lifecycle_1.0.5    
#> [82] hardhat_1.4.2       MASS_7.3-65         sparsevctrs_0.3.6
```
